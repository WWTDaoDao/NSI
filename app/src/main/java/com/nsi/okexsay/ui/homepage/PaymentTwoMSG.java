...
//确认付款，微信支付宝
public class PaymentTwoMSG extends BaseActivity implements View.OnClickListener {
        ...
        HttpRequest.post(StaticField.CANCEL, params, new BaseHttpRequestCallback<ApiResponse>() {
            ...
            public void onFailure(int errorCode, String msg) {
                ...
                if (msg.equals("CODE_REE")) {
                    startActivity(new Intent(PaymentTwoMSG.this,LoginActivity.class));
                } else {
                    showShortToast(msg);
                }
            ...
            public void onSuccess(ApiResponse apiResponse) {
                ...
                if (paymentstr.equals("1")) {
                    if (jsonObject.getString("yh_zfb_wx").equals("1")) {
                        ...
                        Tv_order.setText("订单编号:"+jsonObject.getJSONObject("c2cOrder").getString("orderNo"));
                        je.setText(jsonObject.getString("sjfy"));
                        GlideUtil.diskCacheStrategy(StaticField.HOST_BASE+jsonObject.getString("wxPath"), PaymentTwoMSG.this, IV_zhifu, R.mipmap.img_building);
                    } else {
                    ...
                    if (jsonObject.getString("yh_zfb_wx").equals("2")) {
                        ...
                        Tv_order.setText("订单编号:"+jsonObject.getJSONObject("c2cOrder").getString("orderNo"));
                        je.setText(jsonObject.getString("sjfy"));
                        GlideUtil.diskCacheStrategy(jsonObject.getString("zfbPath"), PaymentTwoMSG.this, IV_zhifu, R.mipmap.img_building);
                    } else {
                        showLongToast("暂无支付方式");
                    }
                }
