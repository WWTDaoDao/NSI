...
import com.nsi.okexsay.adapter.BiBiAdapter;
...
//获取币币交易数据
public class BiBiFragment extends BaseFragment implements BiBi_in.View {
    ...
    public static BiBiFragment newInstance() {

        Bundle args = new Bundle();

        BiBiFragment fragment = new BiBiFragment();
...
//        list_data.addAll(list);
       // if (adapter != null) {
        ...
        //} else {
         //   adapter = new BiBiUSDTAdapter( list_data);
           // idRecyclerview.setAdapter(adapter);
      //  }
    }
