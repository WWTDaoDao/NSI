...
public class LawPageorderPaymentAdapter extends BaseQuickAdapter<LawPurchaseBean, BaseViewHolder> {

    public LawPageorderPaymentAdapter(@LayoutRes int layoutResId) {
        super(layoutResId);
    }
