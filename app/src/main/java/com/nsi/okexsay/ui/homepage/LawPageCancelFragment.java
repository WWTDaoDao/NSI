...
import com.nsi.okexsay.ui.homepage.adapter.LawPageCanceAdapter;
 ...
 * 已取消
 */
public class LawPageCancelFragment extends BaseFragment implements View.OnClickListener {
    ...
    private LawPageCanceAdapter adapter;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Shoudialog();
        getProgres(pageNo);
        adapter = new LawPageCanceAdapter(R.layout.item_law_quxiao);
